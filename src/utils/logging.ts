...
export const logInteraction = async (interaction: CommandInteraction) => {
  Sentry.withScope(async (scope) => {
    scope.setContext("event", { name: "interactionCreate" });
    scope.setContext("function", { name: "logInteraction" });
...
export const logMessage = async (message: Message | PartialMessage) => {
  Sentry.withScope(async (scope) => {
    scope.setContext("event", { name: "messageCreate" });
    scope.setContext("function", { name: "logMessage" });
